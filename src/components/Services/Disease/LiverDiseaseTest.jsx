...
const LiverDiseaseTest = ({ onPrediction, onAnalysis }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Get ML prediction
      const mlResponse = await axios.post(`${BASE_URL}/liver`, {
        data: inputData,
      });
      ...
      // Get Gemini analysis
      const prompt = formatDiseasePrompt("Liver Disease Test", inputData);
      const geminiResponse = await axios.post(`${BASE_URL}/analyze-disease`, {
        disease: "Liver Disease Test",
        prompt
      });
