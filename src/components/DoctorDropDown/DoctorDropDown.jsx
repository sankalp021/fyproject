...
function DoctorsDropDown({ testName, testResult = null }) {
  ...
  // For development, use static doctor data until backend is ready
  const mockDoctors = [
    { _id: "1", name: "Dr. John Smith" },
    { _id: "2", name: "Dr. Sarah Wilson" },
    { _id: "3", name: "Dr. Michael Brown" }
  ];

  const { data: doctors, loading, error } = { data: mockDoctors, loading: false, error: null };
